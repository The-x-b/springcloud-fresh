...
<html>
<head>
<link href="../images/logo.png" rel="icon" type="images/x-icon" />
...
$(function(){
			...
			$.post("../Fresh/jugement",{commodityName:commodityName},function(data){
		...
		<div class="l_wrap fl clearfix">
			<div class="new_goods">
				...
				<ul>
					...
					<li><a href="#"><img
							src="../images/goods/goods021.jpg"></a>
						<h4>
							<a href="#">基围虾</a>
						</h4>
					...
					<li><a href="#"><img
							src="../images/goods/goods020.jpg"></a>
						<h4>
							<a href="#">秋刀鱼</a>
						</h4>
